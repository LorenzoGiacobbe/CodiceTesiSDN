...
"""of-enum.py: Enumerates Openflow participants"""
...
argParser = argparse.ArgumentParser(description='Enumerates Openflow participants')
argParser.add_argument('--version', '-v', action='version', version='%(prog)s is at version 1.0.0')
argParser.add_argument('targets', type=str, help='Text file containing the addresses to enumerate')
